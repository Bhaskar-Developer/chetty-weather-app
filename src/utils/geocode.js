...
const geocode = (address, callback) => {
  ...
  const geocodeurl = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodedAddress}.json?access_token=pk.eyJ1IjoiYMHFud3piNm5vIn0.mGn_nnt3W96M5ajLF2Ltgg&limit=1`
